...
# Extracting non diagonal lines from list
orthogonal_lines = []
for item in lines:
...
# print("Lines_start_end: ", orthogonal_lines[0] )
# print("All the points start: ", orthogonal_lines_points[0][0:5])
# print("All the points end: ", orthogonal_lines_points[0][-5:])
